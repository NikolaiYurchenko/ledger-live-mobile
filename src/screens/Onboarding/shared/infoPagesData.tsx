...
const lottieAnimations: Record<DeviceNames, lottieParams> = {
  nanoS: {
...
enum SceneTypeEnum {  PRIMARY= "primary",  SECONDARY = "secondary" };
const pinCodeScenes = (deviceModelId: DeviceNames) => [
  {
    sceneProps: {
...
const getRecoveryPhraseScenes = (deviceModelId: DeviceNames) => [
  {
    sceneProps: {
